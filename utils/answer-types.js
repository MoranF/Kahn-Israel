...
var inexactMessages = {
	unsimplified: " התשובה שלך כמעט נכונה, אך צריך לפשט אותה. ",
	missingPercentSign: " התשובה שלך כמעט נכונה, אך חסר לה <code>\\%</code> בסופה . "
};
...
$.extend( Khan.answerTypes, {
	...
	number: function( solutionarea, solution, fallback, accForms ) {
		...
		var forms = {
			...
			integer: {
				...
				example: "מספר שלם, לדוגמא <code>6</code>"
			},
			...
			pi: {
				...
				example: "מכפלה של פאי, כמו <code>12\\ \\text{pi}</code> או <code>2/3\\ \\text{pi}</code>"
			},
			...
			log: {
				...
				example: "ביטוי מהסוג <code>\\log(100)</code>"
			},
			...
			percent: {
				...
				example: "אחוז, לדוגמא <code>12.34\\%</code>"
			},
			...
			dollar: {
				...
				example: "סכום כסף, לדוגמא <code>₪2.75</code>"
			},
	...
	radical: function( solutionarea, solution ) {
		...
		if ( options.simplify === "required" ) {
			ret.examples = [ "שורש מפושט, לדוגמא <code>\\sqrt{2}</code> or <code>3\\sqrt{5}</code>" ];
		} else {
			ret.examples = [ "שורש, לדוגמא <code>\\sqrt{8}</code> or <code>2\\sqrt{2}</code>" ];
		}
		ret.solution = ans;
		ret.showGuess = function( guess ) {
	...
	radio: function( solutionarea, solution ) {
		...
		if( showNone ) {
			var none = $( "<span>אף תשובה לא נכונה</span>" );
	...
	primeFactorization: function( solutionarea, solution, fallback ) {
		...
		verifier.examples = [
			"",
			"",
			"פירוק לגורמים כגון ,  <code>2 \\times 3</code>",
			"מספר ראשוני יחיד כגון <code>5</code>",
			"בשפת מחשב, כפל נכתב בעזרת הסימן <b>*</b>"
		];
	...
	var realArea = $("<p />").html(" יחידות של החלק הממשי ");
		var realValidator = Khan.answerTypes["number"]( realArea, realControl, 0 );

        var imagArea = $("<p />").html(" יחידות של החלק המדומה ");
		...
		ret.examples = [
			"החלקים מהמספר המרוכב, לדוגמא (<code>5.3 - 3i</code> בעל חלק ממשי של 5.3 וחלק מרוכב של -3)"
		];
	...
	complexNumberPolarForm: function ( solutionarea, solution ) {
		...
		row.append( '<td style="width: 100px">\n'+
			'רדיוס: <span id="current-radius"><code>1</code></span>\n'+
            "</td>")
            .append("<td>\n" +
        ...
        row = $("<tr />");
		row.append( '<td style="width: 100px">\n'+
			'זווית: <span id="current-angle"><code>0</code></span>\n'+
            "</td>")
            .append("<td>\n" +
