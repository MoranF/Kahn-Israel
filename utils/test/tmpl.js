...
function initVars() {
	$("#qunit-fixture").tmplLoad( null, { testMode: true } );
...
test("Var Replacement", 6, function() {
	...
	var span = $("#qunit-fixture").tmpl().children( "span" );
...
test("Code Replacement", 10, function() {
	...
	var code = $("#qunit-fixture").tmpl().children( "code, span" );
...
test("If Statement", 3, function() {
	...
	var div = $("#qunit-fixture").tmpl().children( "div" );
...
test("Unwrap", function() {
	...
	equals( $("#qunit-fixture > b").length, 1, "See that the div was unwrapped." );
	equals( $("#qunit-fixture > i").length, 1, "See that the div was unwrapped with a true if." );
	equals( $("#qunit-fixture > u").length, 0, "See that the div was unwrapped with a false if." );
});
...
test("Looping", 23, function() {
	...
	var li = $("#qunit-fixture ul.a li");

	equals( li.length, 3, "See that the list items were generated." );
	equals( $( li[0] ).data( "each" ), undefined, "Verify the data-each attribute was removed." );

	// test data-each="items as value"
	li = $("#qunit-fixture ul.b li");
	...
	equals( $("#qunit-fixture div.d").length, 0, "Make sure the non-looped div doesn't exist." );

	// test data-each="items as key, value" on an object
	li = $("#qunit-fixture ul.e li");
...
test( "Inheritance", function() {
	...
	$( "#test-base-1" ).data( "inherited", true );

	// Test appendContents
	$("#qunit-fixture *").tmplApply({ attribute: "class", defaultApply: "appendContents" });

	equals( $("#test-base-1").children("p").length, 4, "Verify that child nodes were appended." );
});
