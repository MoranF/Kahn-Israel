...
function verifyStatementArgs(statement, reason, category) {
    ...
    if (category === "triangle congruence") {
        ...
        if (triangle1 == null || triangle2 == null) {
            return "המשולשים האלו אינם מסורטטים...";
        }
        ...
        if (ang1 == null || ang2 == null) {
            return "הזוויות האלו אינם בשרטוט...";
        }
        ...
        if (seg1 == null || seg2 == null) {
            return "החלקים האלו אינם בשרטוט...";
        }
        ...
        return "לא בחרת סיבה למה הטיעון הזה נכון";
    }
    ...
    for (var i = 0; i < 10; i++) {
        ...
        if (tryProving[0] === "t") {
            ...
            if (useToProve.length > 0) {
                return ["אתה יודע ש" + prettifyEquality(useToProve[0][0] + "," + useToProve[0][1])
                + ", " + prettifyEquality(useToProve[1][0] + "," + useToProve[1][1])
                + ", וגם " + prettifyEquality(useToProve[2][0] + "," + useToProve[2][1]) + ". מה אתה יכול להוכיח מזה?", 
                "דבר שימושי להוכיח פה הוא " + prettifyEquality(triangle1 + "," + triangle2)];
            }
        }
            ...
            if (useToProve.length > 0) {
                return ["אתה יודע ש" + prettifyEquality(useToProve[0] + "," + useToProve[1]) + ". איזה חלקים אתה יכול להוכיח ששווים לזה?",
                "דבר שימושי להוכיח פה הוא " + prettifyEquality(seg1 + "," + seg2)];
            }
        }
            ...
            if (useToProve.length > 0 && useToProve[0] instanceof Triang) {
                return ["אתה יודע ש" + prettifyEquality(useToProve[0] + "," + useToProve[1]) + ". איזה זוויות אתה יכול להוכיח שהן שוות מזה?",
                "דבר שימושי להוכיח פה הוא " + prettifyEquality(ang1 + "," + ang2)];
            }
            else if (useToProve.length > 0) {
                return ["נסה להשתמש ב" + useToProve + " כדי להוכיח זוג זוויות שוות.",
                 "דבר שימושי להוכיח פה הוא" + prettifyEquality(ang1 + "," + ang2)];
            }
        }

    }
    return "אמממ.... זה לא בסדר, יש פה בעיה אצלנו, אנא דווח על זה כבאג במערכת.";
}
        ...
        if (finishedEqualities[finishedKeys[i]].substring(0, 4) != "Same") {
            if (finishedEqualities[finishedKeys[i]] === "given") {
                ...
                if (numberGivens > 1) {
                    ...
                    proofText += "<code>, \\  </code>ו<code>\\  </code></div>";
                }
                else {
                    proofText += "</div><br><br><h3 style=\"clear:both\">הוכחה</h3>";
                }
                ...
                proofText += prettifyEquality(finishedKeys[i]);
                proofText += " בגלל " + finishedEqualities[finishedKeys[i]] + "</div><br>";
    ...
    for (var i = 0; i < knownKeys.length; i ++) {
        if (knownEqualities[knownKeys[i]].substring(0, 4) != "Same") {
            if (knownEqualities[knownKeys[i]] === "given") {
                ...
                proofText += prettifyEquality(knownKeys[i]);
                proofText += "בגלל " + knownEqualities[knownKeys[i]] + "</div>" + "<br>";
            }
...
function outputFillBlanksProof() {
    var reasonCodes = {"צ.צ.צ" : 0, "ז.צ.ז" : 1, "צ.ז.צ" : 2, "ז.ז.צ" : 3, "חלקים מתאימים במשולשים חופפים חופפים" : 4,
     "זוויות קודקודיות שוות" : 5, "זוויות מתחלפות פנימיות שוות" : 6};
    var proofText = "<h3>נתון</h3>";
    var blanks = 0;
        ...
        if (finishedEqualities[finishedKeys[i]].substring(0, 4) != "Same") {
            if (finishedEqualities[finishedKeys[i]] === "given") {
                ...
                if (KhanUtil.random() < 0.2) {
                    proofText += "<div class=\"" + divName(finishedKeys[i]) + "\">";
                    proofText += prettifyEquality(finishedKeys[i]);
                    proofText += " בגלל <select class=\"missing missingReason\" id=\"" + finishedKeys[i] + "\">"
                    + "<option></option>"
                    + "<option value=\"צ.צ.צ\">משפט חפיפה צלע.צלע.צלע</option>"
                    + "<option value=\"ז.צ.ז\">משפט חפיפה זווית.צלע.זווית</option>"
                    + "<option value=\"צ.ז.צ\">משפט חפיפה צלע.זווית.צלע</option>"
                    + "<option value=\"ז.ז.צ\">משפט חפיפה זווית.זווית.צלע</option>"
                    + "<option>חלקים מתאימים במשולשים חופפים חופפים</option>"
                    + "<option>זוויות קודקודיות שוות</option>"
                    + "<option>זוויות מתחלפות פנימיות שוות</option>"
                    + "</select> </div>" + "<br>";
                    blanks++;
                }
    ...
    if (!giveAway) {
        ...
        if (!firstMissing.hasClass("missingReason")) {
            ...
            if (components[0] === "t") {
                ...
                if (useToProve.length > 0) {
                    return "אנו יודעים ש" + prettifyEquality(useToProve[0][0] + "," + useToProve[0][1])
                    + ", " + prettifyEquality(useToProve[1][0] + "," + useToProve[1][1])
                    + ",  ו  " + prettifyEquality(useToProve[2][0] + "," + useToProve[2][1]) + ". מה אנו יכולים להוכיח מזה?";
                }
            }
            else if (components[0] === "a") {
                var angle1 = finishedKeys[components[1]][0];
                ...
                if (useToProve.length > 0 && useToProve[0] instanceof Triang) {
                    return "אתה יודע ש " + prettifyEquality(useToProve[0] + "," + useToProve[1]) + ". אילו זוויות אפשר להוכיח כשוות מזה?";
                }
                else if (useToProve.length > 0) {
                    return "נסה להשתמש ב" + useToProve + " כדי להוכיח זוג זוויות שוות שימושיות.";
                }
            }
            else {
                var seg1 = finishedKeys[components[1]][0];
                ...
                if (useToProve.length > 0) {
                    return "אתה יודע ש" + prettifyEquality(useToProve[0] + "," + useToProve[1]) + ". אילו חלקים אפשר להוכיח כשווים מזה?";
                }
            }
        }
        // if the next open spot is a justification
            ...
            if(firstMissing[0].id[0] === "t"){
                return "אנו יודעים שהמשולשים הינם חופפים בגלל שצלעות וזוויות בהם חופפים . אילו צלעות או זוויות אנו יודעים "
                + "שהם שווים? אילו מהם אנו יכולים להשתמש?";
            }
            else{
                return "האם זוג הצלעות/זוויות חלק מזוג משולשים חופפים? אם לא ישנם רק 2 סיבות אחרות שבגללן הם יכולים להיות שווים "
                + "(בתרגיל זה).";
            }
        }
    }
        ...
        if ($(".missing").length === 0) {
            ...
            if (!firstMissing.hasClass("missingReason")) {
                ...
                return "השוויון הבא שאנו נצטרך למלא הוא  " + prettifyEquality([finishedKeys[components[1]][0], finishedKeys[components[1]][1]]);
            }
            else {
                firstMissing.removeClass("missing");
                return "השוויון חסר הסיבה הינו נכון על ידי  " + finishedEqualities[firstMissing[0].id];
            }
        }
    }
}
...
function outputBadProof() {
    ...
    while (invalidStatements < 1) {
        ...
        if (equalityType === 1) {
            ...
            if (!checkSegEqual(seg1, seg2, "CPCTC")) {
                invalid = [seg1, seg2];
                knownEqualities[invalid] = "חלקים מתאימים במשולשים חופפים חופפים";
                knownEqualities[invalid.reverse()] = "חלקים מתאימים במשולשים חופפים חופפים";
                invalidStatements++;
            }
        }
            ...
            var reasons = KhanUtil.shuffle(["חלקים מתאימים במשולשים חופפים חופפים",
                 "זוויות קודקודיות שוות", "זוויות מתחלפות פנימיות שוות"]);
            ...
            var reasons = KhanUtil.shuffle(["צ.צ.צ", "ז.צ.ז", "צ.ז.צ", "ז.ז.צ"]);
            for (var i = 0; i < reasons.length; i++) {
    ...
    while (validStatements < 4 && count < 100) {
        ...
        if (equalityType === 1) {
            ...
            if (isRelationPossible([ang1, ang2]) && !eqIn([ang1, ang2], knownEqualities) && !ang1.equals(ang2) &&
                (checkAngEqual(ang1, ang2, "זוויות קודקודיות") || checkAngEqual(ang1, ang2, "זוויות מתחלפות")
            ...
            if (isRelationPossible([triangle1, triangle2]) && !eqIn([triangle1, triangle2], knownEqualities) && !triangle1.equals(triangle2) &&
                (checkTriangleCongruent(triangle1, triangle2, "צ.צ.צ") || checkTriangleCongruent(triangle1, triangle2, "ז.צ.ז")
                || checkTriangleCongruent(triangle1, triangle2, "צ.ז.צ") || checkTriangleCongruent(triangle1, triangle2, "ז.ז.צ"))) {
                validStatements++;
    ...
    if (!eqIn(finalRelation, knownEqualities)) {
        if (eqIn(finalRelation, finishedEqualities)) {
            ...
            proofText += " בגלל ש" + finishedEqualities[finalRelation] + "</div>" + "<br>";
        }
        else {
            proofText += "<div class=\"" + divName(finalRelation.toString()) + "\">";
            proofText += prettifyEquality(finalRelation);
            if (finalRelation[0] instanceof Triang) {
                proofText += " בגלל " + KhanUtil.randFromArray(["צ.צ.צ", "ז.צ.ז", "צ.ז.צ", "ז.ז.צ"]) + "</div>" + "<br>";
            }
            else if (finalRelation[0] instanceof Ang) {
                proofText += " בגלל ש"
                + KhanUtil.randFromArray(["זוויות קודקודיות שוות", "זוויות מתחלפות פנימיות שוות", "חלקים מתאימים במשולשים חופפים חופפים"])
                + "</div>" + "<br>";
            }
            else {
                proofText += "בגלל ש" + "חלקים מתאימים במשולשים חופפים חופפים" + "</div>" + "<br>";
            }
        }
    }
    ...
    if (depth === 0) {
        ...
        if (statementKey[0] instanceof Triang) {
            ...
            if (!(sharedSeg.length === 0)) {
                ...
                if (congruence === 1) {
                    setGivenOrTraceBack([[triangle1.segs[(sharedSegIndex + 1) % 3], triangle2.segs[(sharedSegIndex + 1) % 3]],
                        [triangle1.segs[(sharedSegIndex + 2) % 3], triangle2.segs[(sharedSegIndex + 2) % 3]]], "צ.צ.צ", statementKey, depth - 1);
                }
                ...
                // the shared segment be the S
                    ...
                    setGivenOrTraceBack([[triangle1.angs[sharedSegIndex], triangle2.angs[sharedSegIndex]],
                     [triangle1.angs[(sharedSegIndex + 2) % 3], triangle2.angs[(sharedSegIndex + 2) % 3]]], "ז.צ.ז", statementKey, depth - 1);
                }
                ...
                // have the shared segment be one of the S's
                    ...
                    if (KhanUtil.random() < 0.5) {
                        setGivenOrTraceBack([[triangle1.angs[sharedSegIndex], triangle2.angs[sharedSegIndex]],
                            [triangle1.segs[(sharedSegIndex + 1) % 3], triangle2.segs[(sharedSegIndex + 1) % 3]]], "צ.ז.צ", statementKey, depth - 1);
                    }
                    // with probability 0.5, we choose the congruency to be side ssi, angle ssi+2 % 3, side ssi+2 % 3
                        ...
                        setGivenOrTraceBack([[triangle1.angs[(sharedSegIndex + 2) % 3], triangle2.angs[(sharedSegIndex + 2) % 3]],
                            [triangle1.segs[(sharedSegIndex + 2) % 3], triangle2.segs[(sharedSegIndex + 2) % 3]]], "צ.ז.צ", statementKey, depth - 1);
                    }
                ...
                // have the shared segment be the S
                    ...
                    if (KhanUtil.random() < 0.5) {
                        setGivenOrTraceBack([[triangle1.angs[sharedSegIndex], triangle2.angs[sharedSegIndex]],
                            [triangle1.angs[(sharedSegIndex + 1) % 3], triangle2.angs[(sharedSegIndex + 1) % 3]]], "ז.ז.צ", statementKey, depth - 1);
                    }
            ...
            // triangle congruence case 2: triangles have vertical angles
                ...
                finishedEqualities[[triangle1.angs[verticalAngs[0]], triangle2.angs[verticalAngs[0]]]] = "זוויות קודקודיות שוות";
                finishedEqualities[[triangle2.angs[verticalAngs[0]], triangle1.angs[verticalAngs[0]]]] = "זוויות קודקודיות שוות";
                ...
                if (congruence === 1) {
                    ...
                    if (KhanUtil.random() < 0.5) {
                        setGivenOrTraceBack([[triangle1.segs[(verticalAngs[0] + 1) % 3], triangle2.segs[(verticalAngs[0] + 1) % 3]],
                            [triangle1.angs[(verticalAngs[0] + 1) % 3], triangle2.angs[(verticalAngs[0] + 1) % 3]]], "ז.צ.ז", statementKey, depth - 1);
                    }
                    ...
                    // with probability 0.5, we choose the congruency to be angle va, side va, angle va+2
                        ...
                        setGivenOrTraceBack([[triangle1.segs[verticalAngs[0]], triangle2.segs[verticalAngs[0]]],
                            [triangle1.angs[(verticalAngs[0] + 2) % 3], triangle2.angs[(verticalAngs[0] + 2) % 3]]], "ז.צ.ז", statementKey, depth - 1);
                    }
                }
                    ...
                    setGivenOrTraceBack([[triangle1.segs[verticalAngs[0]], triangle2.segs[verticalAngs[0]]],
                     [triangle1.segs[(verticalAngs[0] + 1) % 3], triangle2.segs[(verticalAngs[0] + 1) % 3]]], "צ.ז.צ", statementKey, depth - 1);
                }
                    ...
                    if (KhanUtil.random() < 0.5) {
                        setGivenOrTraceBack([[triangle1.angs[(verticalAngs[0] + 1) % 3], triangle2.angs[(verticalAngs[0] + 1) % 3]],
                         [triangle1.segs[verticalAngs[0]], triangle2.segs[verticalAngs[0]]]], "ז.ז.צ", statementKey, depth - 1);
                    }
                    ...
                    // with probability 0.5, we choose the congruency to be angle va, angle va+2, side va+1
                        ...
                        setGivenOrTraceBack([[triangle1.angs[(verticalAngs[0] + 2) % 3], triangle2.angs[(verticalAngs[0] + 2) % 3]],
                            [triangle1.segs[(verticalAngs[0] + 1) % 3], triangle2.segs[(verticalAngs[0] + 1) % 3]]], "ז.צ.צ", statementKey, depth - 1);
                    }
                }
            }
            ...
            // triangle congruence case 3: triangles have alternate interior angles
                ...
                finishedEqualities[[triangle1.angs[alternateAngs[0]], triangle2.angs[alternateAngs[0]]]] = "זוויות מתחלפות פנימיות שוות";
                finishedEqualities[[triangle2.angs[alternateAngs[0]], triangle1.angs[alternateAngs[0]]]] = "זוויות מתחלפות פנימיות שוות";
                ...
                if (congruence === 1) {
                    ...
                    if (KhanUtil.random() < 0.5) {
                        setGivenOrTraceBack([[triangle1.segs[(alternateAngs[0] + 1) % 3], triangle2.segs[(alternateAngs[0] + 1) % 3]],
                            [triangle1.angs[(alternateAngs[0] + 1) % 3], triangle2.angs[(alternateAngs[0] + 1) % 3]]], "ז.צ.ז", statementKey, depth - 1);
                    }

                    // with probability 0.5, we choose the congruency to be angle va, side va, angle va+2
                    else {
                        setGivenOrTraceBack([[triangle1.segs[alternateAngs[0]], triangle2.segs[alternateAngs[0]]],
                            [triangle1.angs[(alternateAngs[0] + 2) % 3], triangle2.angs[(alternateAngs[0] + 2) % 3]]], "ז.צ.ז", statementKey, depth - 1);
                    }
                }
                    ...
                    // only option for SAS is side va, angle va, side va+1
                    setGivenOrTraceBack([[triangle1.segs[alternateAngs[0]], triangle2.segs[alternateAngs[0]]],
                     [triangle1.segs[(alternateAngs[0] + 1) % 3], triangle2.segs[(alternateAngs[0] + 1) % 3]]], "צ.ז.צ", statementKey, depth - 1);
                }
                    ...
                    if (KhanUtil.random() < 0.5) {
                        setGivenOrTraceBack([[triangle1.angs[(alternateAngs[0] + 1) % 3], triangle2.angs[(alternateAngs[0] + 1) % 3]],
                            [triangle1.segs[alternateAngs[0]], triangle2.segs[alternateAngs[0]]]], "ז.ז.צ", statementKey, depth - 1);
                    }

                    // with probability 0.5, we choose the congruency to be angle va, angle va+2, side va+1
                    else {
                        setGivenOrTraceBack([[triangle1.angs[(alternateAngs[0] + 2) % 3], triangle2.angs[(alternateAngs[0] + 2) % 3]],
                            [triangle1.segs[(alternateAngs[0] + 1) % 3], triangle2.segs[(alternateAngs[0] + 1) % 3]]], "ז.ז.צ", statementKey, depth - 1);
                    }
                }
            ...
            // interior angles
                ...
                if (congruence === 1) {
                    setGivenOrTraceBack([[triangle1.segs[0], triangle2.segs[0]], [triangle1.segs[1], triangle2.segs[1]],
                        [triangle1.segs[2], triangle2.segs[2]]], "צ.צ.צ", statementKey, depth - 1);
                }
                ...
                //ASA
                    ...
                    setGivenOrTraceBack([[triangle1.angs[index], triangle2.angs[index]],
                        ...
                        [triangle1.angs[(index + 1) % 3], triangle2.angs[(index + 1) % 3]]], "ז.צ.ז", statementKey, depth - 1);
                }
                ...
                //SAS
                    ...
                    setGivenOrTraceBack([[triangle1.segs[index], triangle2.segs[index]],
                        ...
                        [triangle1.segs[(index + 1) % 3], triangle2.segs[(index + 1) % 3]]], "צ.ז.צ", statementKey, depth - 1);
                }
                ...
                //AAS
                    ...
                    setGivenOrTraceBack([[triangle1.angs[index], triangle2.angs[index]],
                        ...
                        [triangle1.segs[(index + 2) % 3], triangle2.segs[(index + 2) % 3]]], "ז.ז.צ", statementKey, depth - 1);
                }
            }
        }
        // if we know two segments to be equal
            ...
            // statement key are corresponding
                ...
                setGivenOrTraceBack([[trianglePair[0], trianglePair[1]]], "חלקים מתאימים במשולשים חופפים חופפים",
...
function checkTriangleCongruent(triangle1, triangle2, reason) {
    ...
    if (eqIn([triangle1.segs[0], triangle2.segs[0]], knownEqualities) && eqIn([triangle1.segs[1], triangle2.segs[1]], knownEqualities)
        ...
        if (reason === "צ.צ.צ") {
            knownEqualities[[triangle1, triangle2]] = "צ.צ.צ";
            knownEqualities[[triangle2, triangle1]] = "צ.צ.צ";
    ...
    for (var i = 0; i < 3; i++) {
        if (eqIn([triangle1.angs[i], triangle2.angs[i]], knownEqualities)
            ...
            if (reason === "ז.צ.ז") {
                knownEqualities[[triangle1, triangle2]] = "ז.צ.ז";
                knownEqualities[[triangle2, triangle1]] = "ז.צ.ז";
                knownEqualitiesList.push([triangle1, triangle2]);
    ...
    for (var i = 0; i < 3; i++) {
        ...
        && eqIn([triangle1.segs[(i + 1) % 3], triangle2.segs[(i + 1) % 3]], knownEqualities)) {
            ...
            if (reason === "צ.ז.צ") {
                knownEqualities[[triangle1, triangle2]] = "צ.ז.צ";
                knownEqualities[[triangle2, triangle1]] = "צ.ז.צ";
                knownEqualitiesList.push([triangle1, triangle2]);
    ...
    for (var i = 0; i < 3; i++) {
        if (eqIn([triangle1.angs[i], triangle2.angs[i]], knownEqualities)
            ...
            if (reason === "ז.ז.צ") {
                knownEqualities[[triangle1, triangle2]] = "ז.ז.צ";
                knownEqualities[[triangle2, triangle1]] = "ז.ז.צ";
                knownEqualitiesList.push([triangle1, triangle2]);
    ...
    for (var i = 0; i < 3; i++) {
        if (eqIn([triangle1.angs[i], triangle2.angs[i]], knownEqualities)
            ...
            if (reason === "ז.צ.צ") {
                knownEqualities[[triangle1, triangle2]] = "ז.צ.צ";
                knownEqualities[[triangle2, triangle1]] = "ז.צ.צ";
                knownEqualitiesList.push([triangle1, triangle2]);
                animationObjects = [[triangle1.angs[i], triangle2.angs[i]], [triangle1.angs[(i + 1) % 3], triangle2.angs[(i + 1) % 3]],
    ...
    for (var i = 0; i < seg1.triangles.length; i++) {
        for (var j = 0; j < seg2.triangles.length; j++) {
            ...
            if (checkTriangleCongruent(seg1.triangles[i][0], seg2.triangles[j][0])
                ...
                if (reason === "CPCTC" || reason === "חלקים מתאימים במשולשים חופפים חופפים") {
                    knownEqualities[[seg1, seg2]] = "חלקים מתאימים במשולשים חופפים חופפים";
                    knownEqualities[[seg2, seg1]] = "חלקים מתאימים במשולשים חופפים חופפים";
                    knownEqualitiesList.push([seg1, seg2]);
                    return true;
                }
            }
...
function checkAngEqual(ang1, ang2, reason) {
    ...
    for (var i = 0; i < ang1.triangles.length; i++) {
        for (var j = 0; j < ang2.triangles.length; j++) {
            if (checkTriangleCongruent(ang1.triangles[i][0], ang2.triangles[j][0])
                ...
                if (reason === "CPCTC" || reason === "חלקים מתאימים במשולשים חופפים חופפים") {
                    knownEqualities[[ang1, ang2]] = "חלקים מתאימים במשולשים חופפים חופפים";
                    knownEqualities[[ang2, ang1]] = "חלקים מתאימים במשולשים חופפים חופפים";
    ...
    if (ang1.mid === ang2.mid) {
        ...
        if (sharedLines === 4) {
            if (reason === "זוויות קודקודיות" || reason === "זוויות קודקודיות שוות") {
                knownEqualities[[ang1, ang2]] = "זוויות קודקודיות שוות";
                knownEqualities[[ang2, ang1]] = "זוויות קודקודיות שוות";
                knownEqualitiesList.push([ang1, ang2]);
                return true;
            }
        }
    ...
    if (eqIn([ang1, ang2], altInteriorAngs) || eqIn([ang2, ang1], altInteriorAngs)) {
        ...
        if (reason === "זוויות מתחלפות" || reason === "זוויות מתחלפות פנימיות שוות") {
            knownEqualities[[ang1, ang2]] = "זוויות מתחלפות פנימיות שוות";
            knownEqualities[[ang2, ang1]] = "זוויות מתחלפות פנימיות שוות";
            knownEqualitiesList.push([ang1, ang2]);
            return true;
        }
    }
...
function checkAngForHint(ang1, ang2, equalityObject) {
    ...
    if (ang1.mid === ang2.mid) {
        ...
        if (sharedLines === 4) {
            return "זוויות קודקודיות";
        }
    }

    if (eqIn([ang1, ang2], altInteriorAngs) || eqIn([ang2, ang1], altInteriorAngs)) {
        return "זוויות מתחלפות פנימיות";
    }
...
function sortEqualityList(equalityList, equalityObject) {
    ...
    if(equalityObject === finishedEqualities) {
        ...
        for (var i = 0; i < newEqualityList.length; i++) {
            if (equalityObject[newEqualityList[i]] === "זוויות קודקודיות שוות" || equalityObject[newEqualityList[i]] === "זוויות מתחלפות פנימיות שוות") {
